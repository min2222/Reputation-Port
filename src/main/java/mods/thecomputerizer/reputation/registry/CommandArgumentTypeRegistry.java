...
public class CommandArgumentTypeRegistry {
    ...
    public static final RegistryObject<ArgumentTypeInfo<?, ?>> REPUTATION = TYPE_REGISTRY.register("faction_argument", () -> ArgumentTypeInfos.registerByClass(ReputationFactionArgument.class, SingletonArgumentInfo.contextFree(ReputationFactionArgument::id)));
